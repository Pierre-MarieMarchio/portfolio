...
import { buildScene, RESERVE } from '../rules/scene/matter/grain-reserve.rules';
import {
  framingFor,
  framingScene,
  FramingScene,
} from '../rules/scene/camera/framing.rules';
...
import {
  ...
  onDiskPlane,
  pointerOnCanvas,
} from '../rules/scene/camera/pointer.rules';
import {
  NO_INPUTS,
  SceneFrame,
  sceneFrame,
...
export type SceneView = 'home' | 'index' | 'sheet' | 'about' | 'not-found';
...
const TURNABLE: ReadonlySet<SceneView> = new Set(['home', 'index', 'about']);
