import { clamp, litAmount } from '../math';
import { CameraMotion } from '../motions/camera.motion';
import { GrainsMotion } from '../motions/grains.motion';
import { Grain, GrainPose, placeGrain } from '../scene';
import { litShare } from '../../../../rules/scene/grain-reserve.rules';
import {
  flattenedHeight,
  GrainSpot,
  grainSize,
  ...
  litMatter,
  tintStep,
} from '../../../../rules/scene/matter-light.rules';
