...
import { ProjectDetailRouteComponent } from './project-detail-route.component';

const mount = async (slug: string) => {
  TestBed.configureTestingModule({
    imports: [ProjectDetailRouteComponent],
    providers: [
      provideStatewise(),
      {
  ...
  const fixture = TestBed.createComponent(ProjectDetailRouteComponent);
